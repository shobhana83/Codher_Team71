...
<head>
    ...
    <title>Dashboard | Dyslexia_Master</title>
    ...
    <nav class="navbar navbar-default title1">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="Javascript:void(0)"><b>Dyslexia_Master</b></a>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <?php if(@$_GET['q']==0)
                {
                   echo "<center><h1> WELCOME TO Admin Page!!
					</h1></center>";
                ...
                if(@$_GET['q']== 2) 
                {
                    ...
                    <tr style="color:blue"><td><center><b>Rank</b></center></td><td><center><b>Name</b></center></td><td><center><b>Score</b></center></td></tr>';
                    $c=0;
