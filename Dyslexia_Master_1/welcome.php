...
<head>
    ...
    <title>Welcome | Dyslexia_Master</title>
...
<body>
    <nav class="navbar navbar-default title1">
        ...
        <a class="navbar-brand" href="#"><b>Dyslexia_Master</b></a>
        </div>
        ...
        <ul class="nav navbar-nav navbar-left">
            ...
            <li <?php if(@$_GET['q']==4) echo'class="active"'; ?>> <a href="dash_user.php?q=4"><span class="glyphicon glyphicon-stats" aria-hidden="true"></span>&nbsp;Dashboard</a></li>
                ...
                <?php
                    if(@$_GET['q']== 'quiz' && @$_GET['step']== 2) 
                    {
                        ...
                        while($row=mysqli_fetch_array($q) )
                        {
                            ...
                            $qns=$row['qns'];
                            $qid=$row['qid'];
                            echo '<b>Question &nbsp;'.$sn.'&nbsp;::<br /><br />'.$qns.'</b><br /><br /><img src="data:img;base64,'.base64_encode($row['img'] ).'" height="200" width="200" />';
                        }
                        $q=mysqli_query($con,"SELECT * FROM options WHERE qid='$qid' AND eid= '$eid' " );
                        ...
                        while($row=mysqli_fetch_array($q) )
                        {
                            ...
                            echo'<input type="radio" style= "height:35px; width:35px;" name="ans" value="'.$optionid.'">&nbsp;<img src="data:img;base64,'.base64_encode($option).'" height="200" width="200" />';
                        }
